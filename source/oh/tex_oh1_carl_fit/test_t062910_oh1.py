...
def cal_tex(data, inf408):
	...
	## Fit or not #
	zrolvyn = 1
	tauyn   = [1,1,1,1,1,1,1,1]
	v0yn    = [1,1,1,1,1,1,1,1]
	widyn   = [1,1,1,1,1,1,1,1]

	cont  = tc1665
	zrolv = 0.
	tau   = [0.0128,0.03,0.0125,0.1,0.08,0.05,0.03,0.025]
	...
	tex   = [3.5, 3.4, 2.2, 4.0, 6.6, 5.3, 3.9, 3.6]
	texyn = [1,1,1,1,1,1,1,1]
	...
	# bsl = []
	# er  = []
	# for x in np.arange(71.12,71.18,0.001):
	# 	tfita, sigma, \
	# 	zrolvfite1, taufite1, v0fite1, widfite1, texfite1, \
	# 	zrolv_ere1, tau_ere1, v0_ere1, wid_ere1, tex_ere1, \
	# 	cont_eme1,\
