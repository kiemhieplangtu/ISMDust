...
ohsrc, xl, xb     = read_23src_with_OH(fname = '../../../oh/result/23src_with_oh_3.dat')
...
fig.tight_layout()
fig.savefig('src_examples_apd3.eps', format='eps', bbox_inches='tight', pad_inches=0.05, dpi=100)
fig.show()