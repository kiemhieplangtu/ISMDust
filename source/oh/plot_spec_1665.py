...
def plot_1665(data):
	...
	for src in src_list:
		...
		# Plot #
		fig    = cplot()
		# trace1 = fig.lines(x1,t_on1,label='1665',
		# 		prop=dict(color='b',
		# 			      linewidth=1,
		# 			      linestyle='solid',
		# 			      marker='o',
		...
		trace1 = fig.lines(x1,t_off1,label='1665',
				prop=dict(color='b',
					      linewidth=1,
					      linestyle='solid',
					      marker='o',
		...
		data   = [trace1]
		layout = dict(title  = 'Emission: '+src,
					  title_fontsize=30,
		              grid   = True,
		              legend = dict(loc='upper left', fontsize=18),
		              xaxis  = dict(label='vlsr (km/s)',tick_size=18,fontsize=35,xlim=[-60.,60.]),
		              yaxis  = dict(label='T(K)',tick_size=18,fontsize=35),
		              text   = [dict(loc=[-0.5,0.4],text='',color='blue',fontsize=17),
		              			dict(loc=[-0.5,0.31],text='',color='red',fontsize=19)
		              		   ],
		             )
