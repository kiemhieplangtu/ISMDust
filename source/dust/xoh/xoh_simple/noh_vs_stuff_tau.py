...
## Read info of XOH from tau, Ebv, Radiance #
 ...
 # version 4/2017
 # Author Van Hiep ##
def read_noh(fname = 'noh_vs_stuff.txt'):
...
#================= MAIN ========================#
src, xl, xb, xoh, xoher, nh2, nh2er, nhi, nhier, nh, nher, cnm, cnmer, noh, noher, av, aver = read_noh(fname = 'noh_vs_stuff_tau.txt')
...
for i in range(len(src)):
	# if(oh[i] > 0):
	plt.annotate('('+str(src[i])+')', xy=(av[i], noh[i]), xycoords='data',
