...
def main(data, inf408):
	...
	oh_f1  = data.la.cfr_bd2
	vlsr1  = data.la.vlsr_bd2
	...
	for src in src_list:
		...
		cont       = round(tc1665,2)  # Tc
		contoff    = round(tbg1665,2)  # quan trong, thay doi la thay doi Tex rat nhieu
		tbaseline  = round(bg_off1665,2)  # baseline of 1665 Absorption line
