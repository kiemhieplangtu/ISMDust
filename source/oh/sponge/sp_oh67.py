...
## Read 19 OH sources from SPONGE data to Analyse #
 #
 # params string fname Filename
 # return dict info of 19-OH sources in SPONGE
 # 
 # version 10/2016
 # Author Van Hiep ##
def read_19_src(fname = 'sub_data/19src_to_go.txt'):
	cols = ['idx','src','id']
	fmt  = ['i','s', 's']
	data = restore(fname, 2, cols, fmt)
	return data.read()
