...
def cal_tex(data, inf408):
	...
	em_avg1 = ohmd.correct_ctrl_chnl(data.la.i_em_avg_bd1)
	em_med1 = ohmd.correct_ctrl_chnl(data.la.i_em_med_bd1)
	ab_avg1 = ohmd.correct_ctrl_chnl(data.la.i_abs_avg_bd1)
	ab_med1 = ohmd.correct_ctrl_chnl(data.la.i_abs_med_bd1)

	em_avg2 = ohmd.correct_ctrl_chnl(data.la.i_em_avg_bd2)
	em_med2 = ohmd.correct_ctrl_chnl(data.la.i_em_med_bd2)
	ab_avg2 = ohmd.correct_ctrl_chnl(data.la.i_abs_avg_bd2)
	ab_med2 = ohmd.correct_ctrl_chnl(data.la.i_abs_med_bd2)
	...
	xmax_id  = ohmd.get_vel_index(x, xmin)   # xmax_index
	xmin_id  = ohmd.get_vel_index(x, xmax)   # xmin_index
	...
	bsl = []
	er  = []
	for x in np.arange(46.97,46.99,0.001):
		tfita, sigma, \
		zrolvfite1, taufite1, v0fite1, widfite1, texfite1, \
		zrolv_ere1, tau_ere1, v0_ere1, wid_ere1, tex_ere1, \
		cont_eme1,\
