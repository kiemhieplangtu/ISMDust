...
def cal_tex(data, inf408):
	...
	# bsl = []
	# er  = []
	# for x in np.arange(21.,28.,0.5):
	# 	tfita, sigma, \
	# 	zrolvfite1, taufite1, v0fite1, widfite1, texfite1, \
	# 	zrolv_ere1, tau_ere1, v0_ere1, wid_ere1, tex_ere1, \
	# 	cont_eme1,\
	# 	cont_ere1,\
	# 	cove1, nloope1, nloopmax = fit.fit( xd, tde - tbaseline + x, vrange, \
	# 		zrolv, tau, v0, wid, tex, \
	#     	zrolvyn, tauyn, v0yn, widyn, texyn, \
	#     	x,\
	#     	contemyn)
 ...
 #    	contemyn)
	...
	print texfite1
	print tex_ere1
	print 'baseline final fit:', tbaseline #@ 71.77
	print '1665 Tau:'
	print taufit1
	print tau_er1
	print nloope1
