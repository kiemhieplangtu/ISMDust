...
def cal_tex(data, inf408):
	...
	for src in src_list:
		...
		continuum_defln = 35.15
		continuumyn = 1

		zrocnm   = 0.
		taucnm   = [0.6/continuum_defln, 1.2/continuum_defln, 0.5/continuum_defln, 4./continuum_defln, 3./continuum_defln,2./continuum_defln,1.5/continuum_defln,1./continuum_defln]
		cencnm   = [0.19,1.44,1.1,3.6,4.7,6.1,6.9,8.0]
		widcnm   =[.5,.5,.5,.5,.5,.5,.5,.5]
		...
		tspincnm   = [3.5, 3.4, 2.2, 4.0, 6.6, 5.3, 3.9, 3.6]
		tspincnmyn = [1,1,1,1,1,1,1,1]
		tbaseline  = 71.16
		...
		tspincnm= [2.2, 8.4, 0.5, 2.7, 3.3, 4.7, 1.8, 0.2]
		tspincnmyn= [1,1,1,1,1,1,1,1]
		tbaseline= 71.835
