...
fig, axarr = plt.subplots(nrows=4, ncols=4,figsize=(6,6))
...
for i in range(4):
	...
	axarr[i,0].tick_params(which='both', width=width)
	axarr[i,0].tick_params(which='major', length=mjlen)
	axarr[i,0].tick_params(which='minor', length=mnlen)
	...
	axarr[i,1].tick_params(which='both', width=width)
	axarr[i,1].tick_params(which='major', length=mjlen)
	axarr[i,1].tick_params(which='minor', length=mnlen)
	...
	axarr[i,2].tick_params(which='both', width=width)
	axarr[i,2].tick_params(which='major', length=mjlen)
	axarr[i,2].tick_params(which='minor', length=mnlen)
	...
	axarr[i,3].tick_params(which='both', width=width)
	axarr[i,3].tick_params(which='major', length=mjlen)
	axarr[i,3].tick_params(which='minor', length=mnlen)

	axarr[3,i].set_xlim(xlra[i][1],xlra[i][0])
	axarr[3,i].set_ylim(xbra[i][0],xbra[i][1])
	axarr[3,i].tick_params(axis='both', labelsize=lbsize)
...
fig.savefig('fig4test/src_examples_apd0.eps', format='eps', bbox_inches='tight', pad_inches=0.05, dpi=100)
fig.savefig('fig4test/src_examples_apd1.eps', format='eps', bbox_inches='tight', pad_inches=0.05, dpi=100)
fig.savefig('fig4test/src_examples_apd2.eps', format='eps', bbox_inches='tight', pad_inches=0.05, dpi=100)
fig.savefig('fig4test/src_examples_apd3.eps', format='eps', bbox_inches='tight', pad_inches=0.05, dpi=100)
fig.savefig('fig4test/src_examples_apd4.eps', format='eps', bbox_inches='tight', pad_inches=0.05, dpi=100)
fig.savefig('fig4test/src_examples_apd5.eps', format='eps', bbox_inches='tight', pad_inches=0.05, dpi=100)
fig.show()